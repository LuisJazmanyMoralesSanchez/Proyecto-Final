...
<html lang="en" dir="ltr">
  ...
  <body class="body-registro">
    <h1>Formulario de registro para una consulta medica</h1>
      ...
      <form name="formulario" action="BD/registrar.php" method="post" class="form-registro" onsubmit="return comprobar()">
        ...
        <div class="conenedor-inputs">
          ...
          <p>Direccion</p>
          <input type="text" name="Direccion" placeholder="Escriba su direccion" class="cuadr-gran" required>
          ...
          <input type="text" name="Telefono" placeholder="Escriba su numero de telefono" class="cuadr-gran" required>
          <!-- Boton de envio -->
